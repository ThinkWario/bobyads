        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative aspect-square bg-gray-100 rounded-3xl overflow-hidden border-4 border-white shadow-2xl">
              <div className="w-full h-full flex items-center justify-center text-boby-blue/20 font-bold text-9xl">
                B
              </div>
              {/* Placeholder for a real brand image */}
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-boby-blue">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-boby-blue mb-4">
              Nuestros Pilares Innegociables
            </h2>
            ...
            {[
              {
                ...
                desc: "No adivinamos. Utilizamos datos reales y auditorías técnicas para tomar cada decisión de pauta.",
              },
              {
                icon: Zap,
                title: "Velocidad de Ejecución",
                desc: "El mercado no espera. Implementamos, medimos y optimizamos en ciclos rápidos para ganar ventaja competitiva.",
              },
              {
                icon: ShieldCheck,
                title: "Transparencia Total",
                desc: "Tus datos son tuyos. Reportes claros, sin métricas de vanidad, enfocados únicamente en el ROI y la facturación.",
              },
            ].map((value, i) => (
              <motion.div
                key={i}
                ...
                whileHover={{ y: -10 }}
                className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center group"
              >
      ...
      <SectionWrapper bg="white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-boby-blue text-white p-12 rounded-3xl relative overflow-hidden"
          >
      ...
      <SectionWrapper bg="blue" className="py-20">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-8">
            ¿Construimos tu sistema de crecimiento?
          </h2>
