    ...
    <div className="flex flex-col min-h-screen">
      ...
      <SectionWrapper bg="white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          {/* Right Side: Form */}
          <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-white p-8 md:p-12 rounded-3xl shadow-2xl border border-gray-100 relative">
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input required type="text" placeholder="Ej. Juan Pérez" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-boby-blue focus:ring-2 focus:ring-boby-blue/20 outline-none transition-all" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-boby-dark/70 ml-1">Email Corporativo</label>
                    <input required type="email" placeholder="juan@empresa.com" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-boby-blue focus:ring-2 focus:ring-boby-blue/20 outline-none transition-all" />
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-bold text-boby-dark/70 ml-1">Sitio Web / Landing Page</label>
                  <input required type="url" placeholder="https://tu-sitio.com" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-boby-blue focus:ring-2 focus:ring-boby-blue/20 outline-none transition-all" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea required rows={4} placeholder="Cuéntanos sobre tu negocio y qué quieres lograr..." className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-boby-blue focus:ring-2 focus:ring-boby-blue/20 outline-none transition-all resize-none"></textarea>
                </div>

                <Button type="submit" variant="primary" className="w-full py-4 text-lg bg-boby-blue text-white hover:bg-boby-blue/90 flex items-center justify-center gap-2" disabled={status === "submitting"}>
                  {status === "submitting" ? (
      ...
      <SectionWrapper bg="light" className="py-20">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <Button href="https://wa.me/56912345678" variant="primary" className="px-10 py-4 text-lg bg-green-500 text-white hover:bg-green-600">
